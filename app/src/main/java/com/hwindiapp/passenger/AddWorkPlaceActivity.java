...
//	ActionBar actionBar;
	...
	Marker initial_work_location_marker;
	LatLng user_selected_latLng;

	ProgressDialog pDialog;

	RippleStyleButton add_work_place_btn;
	...
	String LBL_ADD_WORK_HEADER_TXT_str = "";
	...
	String LBL_ADD_WORK_PLACE_HINT_TXT_str = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_add_work_place);
		...
		back_navigation.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AddWorkPlaceActivity.super.onBackPressed();
			}
		});

		dbConnect = new DBConnect(AddWorkPlaceActivity.this, "UC_labels.db");

		text_header = (TextView) findViewById(R.id.text_header);
		mAutocompleteView = (AutoCompleteTextView) findViewById(R.id.AddHomePlace_editBox);
		add_work_place_btn = (RippleStyleButton) findViewById(R.id.add_work_place_btn);
		...
		SharedPreferences mpref_place = PreferenceManager.getDefaultSharedPreferences(AddWorkPlaceActivity.this);
		...
		if (work_address_str != null && userWorkLocationLatitude_str != null && userWorkLocationLongitude_str != null) {

			double work_location_latitude = Double.parseDouble(userWorkLocationLatitude_str);
			double work_location_longitude = Double.parseDouble(userWorkLocationLongitude_str);

			user_selected_latLng = new LatLng(work_location_latitude, work_location_longitude);
		...
		fm.getMapAsync(AddWorkPlaceActivity.this);
		...
		mPrefs = PreferenceManager.getDefaultSharedPreferences(AddWorkPlaceActivity.this);

		add_work_place_btn.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				SharedPreferences.Editor editor = mPrefs.edit();
				editor.putString("userWorkLocationLatitude", "" + user_selected_latLng.latitude);
				editor.putString("userWorkLocationLongitude", "" + user_selected_latLng.longitude);
				editor.putString("userWorkLocationAddress", "" + userSelectedLocationAddress);
	...
	public void onMapReady(GoogleMap gMap) {
		...
		this.map.setOnMapLongClickListener(new OnMapLongClickListener() {
			...
			public void onMapLongClick(LatLng location_latLng) {
				...
				if (initial_work_location_marker != null) {
					initial_work_location_marker.remove();
					initial_work_location_marker = null;
				}

				user_selected_latLng = location_latLng;
				initial_work_location_marker = map
				...
				// CameraUpdate cu =
				// CameraUpdateFactory.newLatLng(location_latLng);
				//
				// map.moveCamera(cu);
	...
	public void getLanguageLabelsFrmSqLite() {
		...
		try {
			...
			LBL_ADD_WORK_HEADER_TXT_str = obj_language_labels.getString("LBL_ADD_WORK_HEADER_TXT");
			...
			LBL_ADD_WORK_PLACE_HINT_TXT_str = obj_language_labels.getString("LBL_ADD_WORK_PLACE_HINT_TXT");
		...
		if (obj_language_labels != null) {
			text_header.setText("" + LBL_ADD_WORK_HEADER_TXT_str);
			hint_txt.setText("" + LBL_LONG_TOUCH_CHANGE_LOC_TXT_str);
			mAutocompleteView.setHint("" + LBL_ADD_WORK_PLACE_HINT_TXT_str);
			add_work_place_btn.setText("" + LBL_ADD_PLACE_TXT_str);
		}
	...
	private AdapterView.OnItemClickListener mAutocompleteClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			...
			hideKeyboard();
			pDialog = new ProgressDialog(AddWorkPlaceActivity.this, R.style.DialogTheme_custom);
	...
	private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback = new ResultCallback<PlaceBuffer>() {
		...
		public void onResult(PlaceBuffer places) {
			...
			initial_work_location_marker = map.addMarker(new MarkerOptions().position(place_location).title("Hello"));
...
//			}
		...
		protected void onPostExecute(String result) {
			...
			if (error_connection == false) {
				...
				Toast.makeText(AddWorkPlaceActivity.this, "" + LBL_SOME_ERROR_TXT_str, Toast.LENGTH_LONG).show();
			}
