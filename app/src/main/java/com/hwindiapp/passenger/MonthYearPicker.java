...
public class MonthYearPicker {
	...
	public MonthYearPicker(Activity activity) {
		...
		this.view = activity.getLayoutInflater().inflate(
				R.layout.month_year_picker_view, null);
	}
	...
	public void build(int selectedMonth, int selectedYear,
		...
		builder.setPositiveButton(
				activity.getString(R.string.positive_button_text),
				positiveButtonListener);
		builder.setNegativeButton(
				activity.getString(R.string.negative_button_text),
